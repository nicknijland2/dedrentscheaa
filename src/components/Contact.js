                        ...
                        <Grid item lg={6} md={12} sm={12} xs={12}>
                            <div className={contactClasses.contact}>
                                ...
                                <div className={contactClasses.member}>
                                  ...
                                  <Typography className={contactClasses.name} ><a href="mailto:secretaris.lrdedrentscheaa@gmail.com" style={{textDecoration:"none"}}>Email</a></Typography> 
                                </div>
                                <div className={contactClasses.member}>
                                  <Typography className={contactClasses.name} gutterBottom variant='body1' >Penningmeester Rolf Boer</Typography>
                                  <Typography className={contactClasses.name}><a href="mailto:penningmeester.lrdedrentscheaa@gmail.com" style={{textDecoration:"none"}}>Email</a></Typography> 
                                </div>
                                <div className={contactClasses.member}>
                                ...
                                <div className={contactClasses.member}>
                                  <Typography className={contactClasses.name} gutterBottom variant='body1' >Algemeen commissielid Chantal Wieringa</Typography>
                                  <Typography className={contactClasses.name} ><a href="mailto:info.lrdedrentscheaa@gmail.com" style={{textDecoration:"none"}}> Email</a></Typography> 
                                </div>
                            </div>
